...
import net.minecraft.models.ModelKK;
import net.minecraft.models.ModelKKspawn;
...
RenderingRegistry.instance().registerEntityRenderingHandler(EntityCaveCrawler2Boss.class, new RenderCaveCrawlerBoss(new ModelCaveCrawler(), 0.5F));
...
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.GoldHammer.itemID,(IItemRenderer) new ItemRenderGoldHammer());
...
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.Scythe.itemID,(IItemRenderer) new ItemRenderScythe());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.BlackHalberd.itemID,(IItemRenderer) new ItemRenderBlackHalberd());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.Cmaul.itemID,(IItemRenderer) new ItemRenderCmaul());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.DryRapier.itemID,(IItemRenderer) new ItemRenderDryRapier());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.DryMace.itemID,(IItemRenderer) new ItemRenderDryMace());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.DryLong.itemID,(IItemRenderer) new ItemRenderDryLong());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.D2H.itemID,(IItemRenderer) new ItemRenderD2H());
MinecraftForgeClient.registerItemRenderer(mod_BlocksGalore.Gmaul.itemID,(IItemRenderer) new ItemRenderGmaul());
...
ClientRegistry.bindTileEntitySpecialRenderer(TileEntityDragonEntity.class, new TileEntityDragonRenderer());
